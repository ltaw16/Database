...
def load_movie_categories():
    try:
        ...
        with open('parsed_files/movie_categories.csv') as csv_file:
            errors = []
            ...
            for row in csv_data:
                ...
                try:
                    ...
                    cursor.execute(
                        'INSERT INTO movie_categories VALUES(%s,%s,%s)',
                        row)
                    conn.commit()
        ...
        print(count, "record inserted successfully into movie categories table")
